...
<?php
/**
 * Template Name: Strategic Architecture Page
 **/

get_header(strategicarchitecture); ?>
<main id="main-content">
  ...
  <section class="usa-hero" style="background: url('<?php the_post_thumbnail_url(); ?>') no-repeat center; background-size: cover;">
    <div class="usa-grid">
      <?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('strategic-architecture-callout') ) : 
...
<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('strategoc-box-section') ) : 
