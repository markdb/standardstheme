<?php
/**
 * Template Name: Data Architecture Page
 **/

get_header(dataarchitecture); ?>
<main id="main-content">
 ...
 <div class="usa-overlay"></div>
  ...
  <section class="usa-hero" style="background: url('<?php the_post_thumbnail_url(); ?>') no-repeat center; background-size: cover;">
    <div class="usa-grid">
      <?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('data-architecture-callout') ) : 
...
<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('data-box-section') ) : 
