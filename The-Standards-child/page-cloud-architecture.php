...
<?php
/**
 * Template Name: Cloud Architecture Page
 **/

get_header(cloudarchitecture); ?>
...
<div class="usa-overlay"></div>
  ...
  <section class="usa-hero" style="background: url('<?php the_post_thumbnail_url(); ?>') no-repeat center; background-size: cover;">
    <div class="usa-grid">
      <?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('cloud-architecture-callout') ) : 
...
<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('cloud-box-section') ) : 
